...
async function onSubmit(event) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <Link
        href="/"
        className="mb-10 flex items-center gap-2 group transition-all duration-300"
      >
        ...
        <span className="font-bold text-2xl tracking-tight text-[#2C687B]">
          FleetTracker
        </span>
      </Link>
          ...
          <div className="relative z-10">
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex justify-between items-center mb-2 ml-1">
                  ...
                  <Link
                    href="#"
                    className="text-[10px] font-bold text-[#088395] hover:text-[#2C687B] transition-colors uppercase tracking-widest"
                  >
                    Forgot?
                  </Link>
                </div>
            ...
            <div className="mt-8 pt-8 border-t border-slate-100 text-center">
              <p className="text-slate-400 text-sm font-medium">
                ...
                <Link
                  href="/register"
                  className="font-bold text-[#088395] hover:text-[#2C687B] transition-colors"
                >
                  Sign up
                </Link>
              </p>
